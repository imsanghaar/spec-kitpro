...
<p align="center">
    <a href="https://github.com/imsanghaar/spec-kitpro/actions/workflows/publish.yml"><img src="https://github.com/imsanghaar/spec-kitpro/actions/workflows/publish.yml/badge.svg" alt="Publish"/></a>
    <a href="https://github.com/imsanghaar/spec-kitpro/stargazers"><img src="https://img.shields.io/github/stars/imsanghaar/spec-kitpro?style=social" alt="GitHub stars"/></a>
    <a href="https://github.com/imsanghaar/spec-kitpro/blob/main/LICENSE"><img src="https://img.shields.io/github/license/imsanghaar/spec-kitpro" alt="License"/></a>
    <a href="https://imsanghaar.github.io/spec-kitpro/"><img src="https://img.shields.io/badge/docs-GitHub_Pages-blue" alt="Documentation"/></a>
</p>
...
- [🔧 SpecifyPro CLI Reference](#-specifypro-cli-reference)
...
Launch your AI assistant in the project directory. The `/sp.*` commands are available in the assistant.
...
Once implementation is complete and verified, use **`/sp.git_commit_pr`** to stage changes, commit with an AI-generated message, and create a Pull Request.

```bash
/sp.git_commit_pr
```

You can also use **`/sp.git_push`** and **`/sp.git_pull`** for standard branch synchronization.
...
specifypro init my-project --ai cursor-agent
...
This step creates or updates the `.specifypro/memory/constitution.md` file with your project's foundational guidelines that the AI agent will reference during specification, planning, and implementation phases.
...
- Imam Sanghaar ([@imsanghaar](https://github.com/imsanghaar))
